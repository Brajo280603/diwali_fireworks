<script>
  ...
  import { onMount } from 'svelte';
    ...
    function lightUp(){
        ...
        document.querySelector(".diwali_text").style.fontSize = "3rem"
...
<main>
    ...
    <div class="diya">
       <p class="diwali_text">May the festival of Diwali light up your life with joy, love, and endless blessings.</p>
